/* ============================================================
   AutogyroDash — extensions v0.8.13
   ------------------------------------------------------------
...
(async function() {
  ...
  try {
    document.title = document.title.replace(/v0\.\d+\.\d+/, 'v0.8.13');
    document.querySelectorAll('span.text-xs.pre-mono').forEach(s => {
      if (/^v0\.\d+\.\d+$/.test(s.textContent.trim())) s.textContent = 'v0.8.13';
    });
  } catch (e) {}
  ...
  function buildSourcesContentHtml() {
    return `
      ...
      <div class="text-xs text-muted text-center pt-2">AutogyroDash v0.8.13</div>
    `;
  }
...
/* ============================================================
   ...
   ============================================================ */
/* B2b-2 (v0.8.13) — bouton PDF (hero CTA) en degrade accent Aero (jour/nuit via tokens). */
#pdf-btn {
  border-radius: 9999px !important;
  ...
  color: var(--accent-ink) !important;
  border: none !important;
  transition: transform 0.12s var(--ease), box-shadow 0.15s var(--ease) !important;
  box-shadow: 0 8px 24px var(--accent-soft) !important;
  cursor: pointer;
}
#pdf-btn:hover {
  transform: translateY(-1px) !important;
  box-shadow: 0 10px 30px var(--accent-soft), 0 0 18px var(--accent-soft) !important;
}
...
#weather-france-section .wf-mode-line {
  ...
  // ============================================================
  if (typeof showToast === 'function') {
    showToast('✓ v0.8.13 chargé', 'ok', 3000);
  }
