/* ============================================================
   AutogyroDash — extensions v1.0.24
   ------------------------------------------------------------
...
(async function() {
  ...
  function buildSourcesContentHtml() {
    ...
    return `
      ...
      <div class="text-xs text-muted text-center pt-4 mt-2 border-t border-thin">AutogyroDash v1.0.24</div>
    `;
  }
...
/* ============================================================
   L1+L2 (v1.0.24) — MOBILE « Apple Maps » : carte plein ecran +
...
@media (max-width: 768px) {
  ...
  body.ag-mobile-sheet #tab-plan {
    ...
    isolation: isolate;
    /* v0.8.70 — fond atmospherique identique aux autres pages (glow peach + periwinkle), opaque, jour/nuit via tokens */
    background:
...
#weather-france-section .wf-mode-line {
  ...
  // ============================================================
  if (typeof showToast === 'function') {
    showToast('✓ v1.0.24 chargé', 'ok', 3000);
  }
  console.log('[Extensions v0.6.34] Intégration terminée');
})();

/* ============================================================
   L1+L2 (v1.0.24) — Feuille mobile « Apple Maps » : carte plein ecran +
