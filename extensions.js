/* ============================================================
   AutogyroDash — extensions v1.0.22
   ------------------------------------------------------------
...
(async function() {
  ...
  function buildSourcesContentHtml() {
    ...
    return `
      ...
      <div class="text-xs text-muted text-center pt-4 mt-2 border-t border-thin">AutogyroDash v1.0.22</div>
    `;
  }
...
/* ============================================================
   L1+L2 (v1.0.22) — MOBILE « Apple Maps » : carte plein ecran +
...
@media (max-width: 768px) {
  ...
  #ag-search-pill .map-search-ctrl { position: static !important; width: 100% !important; max-width: none !important; margin: 0 !important; box-shadow: none !important; background: transparent !important; touch-action: none; }
  #ag-search-pill .map-search-input {
    ...
    /* input tapable directement : iOS ouvre le clavier au tap natif (pointer-events:none le bloquait). Le drag reste géré par le grip + seuil vertical. */
  }
  #ag-search-pill .map-search-results { position: static !important; margin-top: 4px; max-height: 40vh; overflow-y: auto; touch-action: auto; }
...
#weather-france-section .wf-mode-line {
  ...
  // ============================================================
  if (typeof showToast === 'function') {
    showToast('✓ v1.0.22 chargé', 'ok', 3000);
  }
  console.log('[Extensions v0.6.34] Intégration terminée');
})();

/* ============================================================
   L1+L2 (v1.0.22) — Feuille mobile « Apple Maps » : carte plein ecran +
