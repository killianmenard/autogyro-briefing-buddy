/* ============================================================
   AutogyroDash — extensions v0.8.24
   ------------------------------------------------------------
  ...
  function buildSourcesContentHtml() {
    return `
      ...
      <div class="space-y-3 text-sm">
        ...
        <div class="muted-bg p-3 rounded"><h3 class="font-semibold text-sm mb-1">🛰️ Imagerie satellite</h3><p class="text-xs">Source : <strong>NASA EOSDIS GIBS</strong> (MODIS, gratuit).</p></div>
      </div>
      <div class="text-xs text-muted text-center pt-2">AutogyroDash v0.8.24</div>
    `;
  }
...
#weather-france-section .wf-mode-line {
  ...
  // ============================================================
  if (typeof showToast === 'function') {
    showToast('✓ v0.8.24 chargé', 'ok', 3000);
  }
