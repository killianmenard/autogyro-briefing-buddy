/* ============================================================
   AutogyroDash — extensions v1.0.29
   ------------------------------------------------------------
...
(async function() {
  ...
  function buildSourcesContentHtml() {
    ...
    return `
      ...
      <div class="text-xs text-muted text-center pt-4 mt-2 border-t border-thin">AutogyroDash v1.0.29</div>
    `;
  }
...
@media (max-width: 768px) {
  ...
  body.ag-sheet-mid #trajet-band { padding-bottom: 24px; }
  ...
  #ag-search-pill {
    ...
    border-radius: 26px;
    box-shadow: 0 6px 20px rgba(31,42,68,.18);
    padding: 0px 10px 8px;    /* padding haut retiré → tout l'espace devient grip */
    transition: opacity .26s ease;
    touch-action: none;
    min-height: 64px;          /* zone minimale attrapable au doigt */
  }
  /* Barre Apple Maps — toujours visible, claire et bien dimensionnée */
  #ag-search-pill .ag-pill-grip { display: flex; justify-content: center; padding: 10px 0 6px; touch-action: none; cursor: grab; }
  #ag-search-pill .ag-pill-grip span { width: 44px; height: 5px; border-radius: 999px; background: var(--text-3, #97a2b2); opacity: .6; }
  /* En mode mid : grip encore plus prononcé */
  body.ag-sheet-mid #ag-search-pill .ag-pill-grip { padding: 14px 0 10px; }
  body.ag-sheet-mid #ag-search-pill .ag-pill-grip span { width: 52px; height: 5px; opacity: .75; background: #94a3b8; }
  /* Toute la pilule indique qu'elle est draggable */
  body.ag-sheet-mid #ag-search-pill { cursor: grab; }
  ...
  #ag-search-pill .map-search-input {
    ...
    pointer-events: auto !important; touch-action: auto !important;   /* tapable nativement : iOS ouvre le clavier au tap (le drag arme seulement hors-input) */
  }
  /* Résultats ancrés SOUS la pilule. La pilule est fixée par son bord bas (bottom recalculé) :
     en position:static les résultats la feraient grandir vers le HAUT (suggestions en haut de page).
     En absolute top:100%, ils descendent depuis le bas de la pilule, dans le bon sens. */
...
#weather-france-section .wf-mode-line {
  ...
  // ============================================================
  if (typeof showToast === 'function') {
    showToast('✓ v1.0.29 chargé', 'ok', 3000);
  }
