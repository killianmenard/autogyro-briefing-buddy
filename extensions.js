/* ============================================================
   AutogyroDash — extensions v1.0.19
   ------------------------------------------------------------
...
(async function() {
  ...
  function buildSourcesContentHtml() {
    ...
    return `
      ...
      <div class="text-xs text-muted text-center pt-4 mt-2 border-t border-thin">AutogyroDash v1.0.19</div>
    `;
  }
...
/* ============================================================
   L1+L2 (v1.0.19) — MOBILE « Apple Maps » : carte plein ecran +
...
@media (max-width: 768px) {
  ...
  #ag-search-pill .map-search-input {
    ...
    touch-action: none; pointer-events: none;   /* l'input ne capte pas le toucher -> toute la pilule devient draggable ; focus via JS au tap */
  }
...
#weather-france-section .wf-mode-line {
  ...
  // ============================================================
  if (typeof showToast === 'function') {
    showToast('✓ v1.0.19 chargé', 'ok', 3000);
  }
  console.log('[Extensions v0.6.34] Intégration terminée');
})();

/* ============================================================
   L1+L2 (v1.0.19) — Feuille mobile « Apple Maps » : carte plein ecran +
