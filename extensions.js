/* ============================================================
   AutogyroDash — extensions v1.0.31
   ------------------------------------------------------------
...
(async function() {
  ...
  function buildSourcesContentHtml() {
    ...
    return `
      ...
      <div class="text-xs text-muted text-center pt-4 mt-2 border-t border-thin">AutogyroDash v1.0.31</div>
    `;
  }
  ...
  function restoreFlight(item) {
    ...
    setTimeout(() => {
      ...
      // Météo : second refresh après 1.5s pour garantir que les cartes sont toutes rendues
      setTimeout(() => { if (typeof refreshAdCards === 'function') refreshAdCards(); }, 1500);
...
#weather-france-section .wf-mode-line {
  ...
  // ============================================================
  if (typeof showToast === 'function') {
    showToast('✓ v1.0.31 chargé', 'ok', 3000);
  }
