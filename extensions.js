/* ============================================================
   AutogyroDash — extensions v1.0.28
   ------------------------------------------------------------
...
(async function() {
  ...
  function buildSourcesContentHtml() {
    ...
    return `
      ...
      <div class="text-xs text-muted text-center pt-4 mt-2 border-t border-thin">AutogyroDash v1.0.28</div>
    `;
  }
...
@media (max-width: 768px) {
  ...
  /* petite barre facon Apple Maps (tirer vers le haut pour deplier la section) */
  #ag-search-pill .ag-pill-grip { display: flex; justify-content: center; padding: 4px 0 5px; touch-action: none; }
  #ag-search-pill .ag-pill-grip span { width: 36px; height: 4px; border-radius: 999px; background: var(--text-3, #97a2b2); opacity: .5; }
  /* En mode mid : grip plus grand et visible pour faciliter le glissement vers le haut */
  body.ag-sheet-mid #ag-search-pill .ag-pill-grip { padding: 10px 0 8px; }
  body.ag-sheet-mid #ag-search-pill .ag-pill-grip span { width: 48px; height: 5px; opacity: .65; }
...
#weather-france-section .wf-mode-line {
  ...
  // ============================================================
  if (typeof showToast === 'function') {
    showToast('✓ v1.0.28 chargé', 'ok', 3000);
  }
