/* ============================================================
   AutogyroDash — extensions v1.0.26
   ------------------------------------------------------------
...
(async function() {
  ...
  function buildSourcesContentHtml() {
    ...
    return `
      ...
      <div class="text-xs text-muted text-center pt-4 mt-2 border-t border-thin">AutogyroDash v1.0.26</div>
    `;
  }
...
/* ============================================================
   L1+L2 (v1.0.26) — MOBILE « Apple Maps » : carte plein ecran +
...
#weather-france-section .wf-mode-line {
  ...
  // ============================================================
  if (typeof showToast === 'function') {
    showToast('✓ v1.0.26 chargé', 'ok', 3000);
  }
  console.log('[Extensions v0.6.34] Intégration terminée');
})();

/* ============================================================
   L1+L2 (v1.0.26) — Feuille mobile « Apple Maps » : carte plein ecran +
...
(function agAppleMapsSheet(){
  ...
  function pxFor(name){
    ...
    return Math.round(0.55*H);                          /* mi-hauteur : feuille (étiquette + recherche) = 45% bas, carte = 55% haut */
  }
  ...
  function setDetent(tp, name, animate){
    ...
    /* au cran milieu, le bas de la feuille est hors ecran -> padding bas = hauteur masquee, sinon le bas du contenu (notes pilote) reste inaccessible */
    var extra = (name === 'mid') ? pxFor('mid') : 0;
    tp.style.paddingBottom = 'calc(' + (extra + 86) + 'px + env(safe-area-inset-bottom, 0px))';
    setBodyDetent(name);
