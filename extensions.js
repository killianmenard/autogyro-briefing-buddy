/* ============================================================
   AutogyroDash — extensions v1.0.25
   ------------------------------------------------------------
...
(async function() {
  ...
  function buildSourcesContentHtml() {
    ...
    return `
      ...
      <div class="text-xs text-muted text-center pt-4 mt-2 border-t border-thin">AutogyroDash v1.0.25</div>
    `;
  }
...
/* ============================================================
   L1+L2 (v1.0.25) — MOBILE « Apple Maps » : carte plein ecran +
...
#weather-france-section .wf-mode-line {
  ...
  // ============================================================
  if (typeof showToast === 'function') {
    showToast('✓ v1.0.25 chargé', 'ok', 3000);
  }
  console.log('[Extensions v0.6.34] Intégration terminée');
})();

/* ============================================================
   L1+L2 (v1.0.25) — Feuille mobile « Apple Maps » : carte plein ecran +
  ...
  function attachDrag(tp, el){
    ...
    function end(){
      ...
      if(dragging){
        ...
        var ty=curTy(tp), order=['full','mid','peek'], best='mid', bd=Infinity;
        for (var i=0;i<order.length;i++){ var d=Math.abs(pxFor(order[i])-ty); if(d<bd){bd=d;best=order[i];} }
