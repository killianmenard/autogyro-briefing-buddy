...
(async function() {
  ...
  function restoreFlight(item) {
    ...
    setTimeout(() => {
      ...
      // Double refresh météo : 800ms (DOM prêt) + 3s (réseau METAR chargé)
      setTimeout(() => { if (typeof refreshAdCards === 'function') refreshAdCards(); }, 800);
      setTimeout(() => { if (typeof refreshAdCards === 'function') refreshAdCards(); }, 3000);
