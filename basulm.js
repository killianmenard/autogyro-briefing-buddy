...
(async function() {
    ...
    return `
      <div class="card p-4 space-y-5">
        ...
        <div class="text-xs text-muted text-center pt-2 border-t border-thin">
          Version v0.6.31 · <a href="#" id="p-link-sources" class="text-blue-600 hover:underline">voir les sources</a>
        </div>
      </div>
    `;
  }
  ...
  function refreshParamsState() {
    ...
    document.querySelectorAll('.p-speed-btn').forEach(b => {
      ...
      b.style.background = active ? _accent : 'var(--card)';
      b.style.color = active ? _accentTxt : 'var(--foreground)';
